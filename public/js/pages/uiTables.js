    ...
    init: function() {
      ...
      $('a.update_value').on('click', function(e){
        ...
        $.ajax({
          ...
          setTimeout(function(){$('#msg_container .alert').addClass('hidden').removeClass('alert-danger').removeClass('alert-success')}, 3000);
        });
      });
      ...
      $('.switch span').click(function(e){
        ...
        $.getJSON('/admin/bool-update/'+table+'/'+id+'/'+field, function(response){
          ...
          setTimeout(function(){$('#msg_container .alert').addClass('hidden').removeClass('alert-danger').removeClass('alert-success')}, 2000);
        });
      });
    }
  };
