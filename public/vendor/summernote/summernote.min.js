!function (a) {
    "function" == typeof define && define.amd ? define(["../../js/jquery"], a) : a(window.jQuery)
}(function (a) {
    ...
    }(), h = String.fromCharCode(160), i = "ο»Ώ", j = function () {
        var b = function (b) {
    ...
    var z = function () {
        ...
        var p = function (b) {
            ...
            var c = b.originalEvent.clipboardData, d = p(b.currentTarget || b.target), e = d.editable();
            if (!c || !c.items || !c.items.length) {
                var f = e.data("callbacks");
                if (!f.onImageUpload)return;
                return h.saveNode(e), h.saveRange(e), e.html(""), void setTimeout(function () {
                    var b = e.find("img");
                    if (b.length && -1 !== b[0].src.indexOf("data:")) {
                        for (var c = b[0].src, f = atob(c.split(",")[1]), g = new Uint8Array(f.length), i = 0; i < f.length; i++)g[i] = f.charCodeAt(i);
                        var j = new Blob([g], {type: "image/png"});
                        j.name = "clipboard.png", h.restoreNode(e), h.restoreRange(e), q(d, [j]), h.afterCommand(e)
                    } else {
                        var k = e.html();
                        h.restoreNode(e), h.restoreRange(e);
                        try {
                            a(k).each(function () {
                                e.focus(), h.insertNode(e, this)
                            })
                        } catch (l) {
                            e.focus(), h.insertText(e, k)
                        }
                    }
                }, 0)
            }
            var i = g.head(c.items), j = "file" === i.kind && -1 !== i.type.indexOf("image/");
            j && q(d, [i.getAsFile()]), h.afterCommand(e)
        }, C = function (b) {
        ...
        var b = function (a, b) {
            ...
            var b = [{kbd: "β + B", text: a.font.bold}, {kbd: "β + I", text: a.font.italic}, {
                kbd: "β + U",
                text: a.font.underline
            }, {kbd: "β + \\", text: a.font.clear}];
            return l(a.shortcut.textFormatting, b)
        }, n = function (a) {
            var b = [{kbd: "β + Z", text: a.history.undo}, {
                kbd: "β + β‡§ + Z",
                text: a.history.redo
            }, {kbd: "β + ]", text: a.paragraph.indent}, {
                kbd: "β + [",
                text: a.paragraph.outdent
            }, {kbd: "β + ENTER", text: a.hr.insert}];
            return l(a.shortcut.action, b)
        }, o = function (a) {
            var b = [{kbd: "β + β‡§ + L", text: a.paragraph.left}, {
                kbd: "β + β‡§ + E",
                text: a.paragraph.center
            }, {kbd: "β + β‡§ + R", text: a.paragraph.right}, {
                kbd: "β + β‡§ + J",
                text: a.paragraph.justify
            }, {kbd: "β + β‡§ + NUM7", text: a.lists.ordered}, {kbd: "β + β‡§ + NUM8", text: a.lists.unordered}];
            return l(a.shortcut.paragraphFormatting, b)
        }, p = function (a) {
            var b = [{kbd: "β + NUM0", text: a.style.normal}, {
                kbd: "β + NUM1",
                text: a.style.h1
            }, {kbd: "β + NUM2", text: a.style.h2}, {kbd: "β + NUM3", text: a.style.h3}, {
                kbd: "β + NUM4",
                text: a.style.h4
            }, {kbd: "β + NUM5", text: a.style.h5}, {kbd: "β + NUM6", text: a.style.h6}];
            ...
            return a.replace(/β/g, "Ctrl").replace(/β‡§/g, "Shift")
        }, t = {
            image: function (a, b) {
                var c = "";
                ...
                var c = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + a.shortcut.close + '</a><div class="title">' + a.shortcut.shortcuts + "</div>" + (e.isMac ? r(a, b) : s(r(a, b))) + '<p class="text-center"><a href="//summernote.org/" target="_blank">Summernote 0.6.2</a> Β· <a href="//github.com/summernote/summernote" target="_blank">Project</a> Β· <a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a></p>';
            ...
            return e.isMac && (a = a.replace("CMD", "β").replace("SHIFT", "β‡§")), a.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]")
        }, x = function (b, c, d) {
