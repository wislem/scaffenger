...
<body>
	...
	<div id="login-container">
		<h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
			<i class="fa fa-history"></i> <strong>Enter new password</strong>
		</h1>
		<div class="block animation-fadeInQuickInv">
			...
			{{Form::open(array('url' => 'scaffenger/reset-password', 'method' => 'POST', 'id' => 'form-reminder', 'class' => 'form-horizontal', 'novalidate' => 'novalidate'))}}
				{{Form::hidden('id', $id)}}
				...
				<div class="form-group">
					<div class="col-xs-12">
						<input type="password" id="password2" name="password2" class="form-control" placeholder="Enter your password again..">
					</div>
				</div>
				<div class="form-group form-actions">
					<div class="col-xs-12 text-right">
						<button type="submit" class="btn btn-effect-ripple btn-sm btn-primary"><i class="fa fa-check"></i> Set new Password</button>
					</div>
				</div>
			{{Form::close()}}
		</div>
